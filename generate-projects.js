...
const projects = [
  ...
  },
  {
    ...
    summaryAr: 'هوية مقهى متكاملة تُجسّد الدفء والتخصصية في كل نقطة تواصل — تجربة بصرية تعكس شخصية المكان قبل أول رشفة.',
  ...
  },
  {
    ...
    summaryAr: 'تصميم مجلة منتجات غذائية لجود الأصيل — كتالوج احترافي يعرض المنتجات الطازجة والمشتريات الغذائية بأسلوب بصري شهي يلفت الانتباه قبل التذوق.',
